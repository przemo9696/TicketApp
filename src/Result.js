...
export const Result = props => {
    ...
    const inDate = moment(ticket.date + ' ' + ticket.time).subtract(14,"seconds").format('DD-MM-YYYY HH:mm:ss');
    var expDate = moment(ticket.date + ' ' + ticket.time).subtract(14, "seconds").format('DD-MM-YYYY HH:mm:ss');
    ...
    switch(ticket.value) {
        ...
        case Ticket1.value:
            price = 4.80;
            expDate = moment(ticket.date + ' ' + ticket.time).add(1,"hours").format('DD-MM-YYYY HH:mm:ss');
        ...
        case Ticket4.value:
            price = 20;
            expDate = moment(ticket.date + ' ' + ticket.time).add(24,"hours").format('DD-MM-YYYY HH:mm:ss');
        ...
        case Ticket9.value:
            price = 15;
            expDate = moment(ticket.date + ' ' + ticket.time).add(72,"hours").format('DD-MM-YYYY HH:mm:ss');
    ...
    return(
        ...
        <div id="outBox">
            ...
            <p> Numer Linii:</p>
            <div id="ans"> {ticket.vehNr}{ticket.vehType} </div>
            ...
            <div id="ans">{(ticket.ticketNum * price).toLocaleString('pl-PL',{minimumFractionDigits:2})} PLN</div>

            <p> Numer transakcji: </p>
            <div id="ans">1000110000239883327</div><br/>
