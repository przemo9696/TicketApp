...
export const TicketForm = props => {
  ...
  if (ticket.ticketType === "ulgowy") {
    selector =
      <select name="value" id="select" value={ticket.value} onChange={onChangeHandler}>
    ...
    <form>
      ...
      <div id="inBox">
        ...
        <div id="in">Wybierz typ biletu:
          <select name="ticketType" id="select" value={ticket.ticketType} onChange={onChangeHandler}>
        ...
        <div id="in">
          ...
          <input name="ticketNum" type="number" value={ticket.ticketNum} onChange={onChangeHandler} placeholder="Liczba biletów"/>
        </div>

        <div id="in">
          Wprowadź numer linii:<br/>
          <input name="vehNr" type="number" value={ticket.vehNr} onChange={onChangeHandler} placeholder="Numer linii"/>
          <label><input type="radio" name="vehType" value=" (tramwaj)" onChange={onChangeHandler}/>Tramwaj</label>
          <label><input type="radio" name="vehType" value=" (autobus)" onChange={onChangeHandler}/>Autobus</label>
        </div>

        <div id="in">
          Wprowadź datę i godzinę:<br/>
          <input name="date" type="date" value={ticket.date} onChange={onChangeHandler}/>
          <input name="time" type="time" value={ticket.time} onChange={onChangeHandler} step="2"/>
      ...
      <Link to={{pathname: "/result"}}>
        <button onClick={buyTicket} id="buyButton">Kup Bilet</button>
      </Link>
